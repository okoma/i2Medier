...
@push('meta')
<meta name="description" content="Portfolio-first web design for architecture firms, architects, and interior designers. i2Medier builds visually stunning, SEO-optimised architecture studio websites that showcase your work and attract premium project enquiries in Nigeria and worldwide."/>
<meta name="keywords" content="web design for architecture firms, architect website design Nigeria, architecture firm portfolio website, architecture studio website Lagos, NIA registered architect website, interior design website Nigeria, architect portfolio website Abuja, architecture company website design, architectural firm web design Nigeria, portfolio website for architects"/>
<meta name="robots" content="index, follow"/>
<meta name="author" content="i2Medier Konceptz"/>
<link rel="canonical" href="{{ url('/services/web-design/architecture-firm-website-design') }}"/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="{{ url('/services/web-design/architecture-firm-website-design') }}"/>
<meta property="og:title" content="Web Design for Architecture Firms | i2Medier"/>
<meta property="og:description" content="We build visually stunning portfolio websites for architecture firms that showcase your best work and attract premium project enquiries. Fast, SEO-optimised, and live in 3–5 weeks."/>
<meta property="og:image" content="{{ url('/og-architecture-web-design.jpg') }}"/>
<meta property="og:site_name" content="i2Medier"/>
<meta name="twitter:card" content="summary_large_image"/>
<meta name="twitter:title" content="Web Design for Architecture Firms | i2Medier"/>
<meta name="twitter:description" content="Portfolio-first architecture studio websites that rank on Google and win premium project enquiries. Nigeria & worldwide specialists."/>
<script type="application/ld+json">{!! json_encode([
  '@context' => 'https://schema.org',
  '@type' => 'Service',
  'name' => 'Web Design for Architecture Firms',
  'serviceType' => 'Architecture Firm Website Design',
  'description' => 'Portfolio-first web design and development services for architecture firms, studios, interior designers, and planning consultancies. We build visually exceptional, fast, and SEO-optimised architecture studio websites that showcase your work and attract premium project enquiries in Nigeria and worldwide.',
  'provider' => [
    '@type' => 'Organization',
    'name' => 'i2Medier',
    'url' => url('/'),
  ...
  'audience' => [
    '@type' => 'Audience',
    'audienceType' => 'Architecture firms, Architecture studios, Interior designers, Urban planners, Landscape architects, Masterplanning consultancies',
  ],
  'offers' => [
    '@type' => 'Offer',
    'priceCurrency' => 'NGN',
    'price' => '400000',
    'description' => 'Architecture firm portfolio website starting from ₦400,000',
  ],
...
<script type="application/ld+json">{!! json_encode([
  ...
  'itemListElement' => [
    ...
    ['@type' => 'ListItem', 'position' => 4, 'name' => 'Web Design for Architecture Firms', 'item' => url('/services/web-design/architecture-firm-website-design')],
  ],
], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}</script>
@endpush
