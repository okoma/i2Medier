...
@push('meta')
<meta name="description" content="Warm, welcoming web design for churches, ministries, and faith communities in Nigeria. i2Medier builds professional church websites that grow your congregation, stream services online, and connect your community — in Lagos, Abuja, and across Nigeria."/>
<meta name="keywords" content="web design for churches Nigeria, church website design, ministry website Nigeria, church website Lagos, Christian ministry website design, church online giving website, church streaming website Nigeria, mosque website design Nigeria, faith community website, religious organisation website Nigeria"/>
<meta name="robots" content="index, follow"/>
<meta name="author" content="i2Medier Konceptz"/>
<link rel="canonical" href="{{ url('/services/web-design/church-website-design') }}"/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="{{ url('/services/web-design/church-website-design') }}"/>
<meta property="og:title" content="Web Design for Churches | Ministry Website Design Nigeria | i2Medier"/>
<meta property="og:description" content="Warm, welcoming church and ministry websites that grow your congregation, stream services online, and collect giving digitally. Nigeria &amp; UK specialists."/>
<meta property="og:image" content="{{ url('/og-church-web-design.jpg') }}"/>
<meta property="og:site_name" content="i2Medier"/>
<meta name="twitter:card" content="summary_large_image"/>
<meta name="twitter:title" content="Web Design for Churches | Ministry Website Design Nigeria | i2Medier"/>
<meta name="twitter:description" content="Professional church and ministry websites that grow your congregation and rank on Google. Nigeria &amp; UK specialists."/>
<script type="application/ld+json">{!! json_encode([
  '@context' => 'https://schema.org',
  '@type' => 'Service',
  'name' => 'Web Design for Churches & Ministries',
  'serviceType' => 'Church Website Design',
  'description' => 'Professional web design and development services for churches, ministries, mosques, and faith communities in Nigeria and the UK. We build warm, SEO-optimised websites with sermon archives, online giving portals, events calendars, and streaming integration.',
  'provider' => [
    '@type' => 'Organization',
    'name' => 'i2Medier',
    'url' => url('/'),
  ...
  'audience' => [
    '@type' => 'Audience',
    'audienceType' => 'Churches, Ministries, Mosques, Faith communities, Evangelical organisations, Religious nonprofits',
  ],
  'offers' => [
    '@type' => 'Offer',
    'priceCurrency' => 'NGN',
    'price' => '350000',
    'description' => 'Church website starting from ₦350,000',
  ],
...
<script type="application/ld+json">{!! json_encode([
  ...
  'itemListElement' => [
    ...
    ['@type' => 'ListItem', 'position' => 4, 'name' => 'Web Design for Churches & Ministries', 'item' => url('/services/web-design/church-website-design')],
  ],
], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}</script>
@endpush
