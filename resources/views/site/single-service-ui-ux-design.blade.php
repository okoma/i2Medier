...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.uiux-page .reveal').forEach(el => obs.observe(el));
  ...
  document.querySelectorAll('.uiux-page .counter').forEach(el => counterObs.observe(el));

  document.querySelectorAll('.uiux-page .faq-q').forEach(btn => {
    btn.addEventListener('click', () => {
      const id = btn.getAttribute('aria-controls');
      const answer = document.getElementById(id);
      const isOpen = btn.getAttribute('aria-expanded') === 'true';
      document.querySelectorAll('.uiux-page .faq-q').forEach(item => {
