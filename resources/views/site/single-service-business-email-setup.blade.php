...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.email-page .reveal').forEach(el => obs.observe(el));
  ...
  document.querySelectorAll('.email-page .counter').forEach(el => cObs.observe(el));

  document.querySelectorAll('.email-page .faq-q').forEach(btn => {
    btn.addEventListener('click', () => {
      const id = btn.getAttribute('aria-controls');
      const answer = document.getElementById(id);
      const isOpen = btn.getAttribute('aria-expanded') === 'true';

      document.querySelectorAll('.email-page .faq-q').forEach(node => {
