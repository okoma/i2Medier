...
<div class="maintenance-page">
  ...
  <section class="packages-section" aria-labelledby="packages-heading" id="packages">
    ...
    <div class="pkg-grid">
      <div class="pkg-card reveal">
        ...
        <div class="pkg-foot"><a href="{{ route('site.start', ['services' => 'wpmaintenance', 'source_page' => 'service-wordpress-maintenance', 'source_label' => 'WordPress Maintenance Service Page']) }}" class="pkg-btn outline">Get Started</a></div>
      </div>
  ...
  <section class="cta-band" id="contact" aria-labelledby="cta-h">
    ...
    <a href="{{ route('site.start', ['services' => 'wpmaintenance', 'source_page' => 'service-wordpress-maintenance-cta', 'source_label' => 'WordPress Maintenance Service CTA']) }}" class="btn-dark">Start My Care Plan →</a>
  </section>
</div>
@endsection
