...
@push('meta')
<meta name="description" content="Lead-generating web design for cleaning companies, domestic cleaning services, commercial cleaners, and facility management firms in Nigeria. i2Medier builds professional cleaning company websites with online quote forms, service pages, and local SEO that win more contracts. Lagos, Abuja & UK specialists."/>
<meta name="keywords" content="web design for cleaning companies Nigeria, cleaning company website design, cleaning service website Lagos, domestic cleaning website Nigeria, commercial cleaning website design, facility management website Nigeria, cleaning business website Lagos, office cleaning website Nigeria, cleaning company website Abuja, janitorial services website Nigeria"/>
<meta name="robots" content="index, follow"/>
<meta name="author" content="i2Medier Konceptz"/>
<link rel="canonical" href="{{ url('/services/web-design/cleaning-company-website-design') }}"/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="{{ url('/services/web-design/cleaning-company-website-design') }}"/>
<meta property="og:title" content="Web Design for Cleaning Companies | i2Medier"/>
<meta property="og:description" content="We build professional websites for cleaning companies that generate steady quote requests and booked contracts. Fast, credible, and optimised for local Google search from day one."/>
<meta property="og:image" content="{{ url('/og-cleaning-web-design.jpg') }}"/>
<meta property="og:site_name" content="i2Medier"/>
<meta name="twitter:card" content="summary_large_image"/>
<meta name="twitter:title" content="Web Design for Cleaning Companies | i2Medier"/>
<meta name="twitter:description" content="Professional cleaning company websites that generate quote requests and rank on Google. Lagos, Abuja & UK specialists."/>
<script type="application/ld+json">{!! json_encode([
  '@context' => 'https://schema.org',
  '@type' => 'Service',
  'name' => 'Web Design for Cleaning Companies',
  'serviceType' => 'Cleaning Company Website Design',
  'description' => 'Professional web design and development services for cleaning companies, domestic cleaning services, commercial cleaners, office cleaning firms, and facility management companies. We build fast, SEO-optimised websites with instant quote forms that attract contracts and build professional credibility online.',
  'provider' => [
    '@type' => 'Organization',
    'name' => 'i2Medier',
    'url' => url('/'),
  ...
  'audience' => [
    '@type' => 'Audience',
    'audienceType' => 'Cleaning companies, Domestic cleaning services, Commercial cleaners, Office cleaning firms, Facility management companies, Janitorial services',
  ],
  'offers' => [
    '@type' => 'Offer',
    'priceCurrency' => 'NGN',
    'price' => '350000',
    'description' => 'Cleaning company website starting from ₦350,000',
  ],
...
<script type="application/ld+json">{!! json_encode([
  ...
  'itemListElement' => [
    ...
    ['@type' => 'ListItem', 'position' => 4, 'name' => 'Web Design for Cleaning Companies', 'item' => url('/services/web-design/cleaning-company-website-design')],
  ],
], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}</script>
@endpush
