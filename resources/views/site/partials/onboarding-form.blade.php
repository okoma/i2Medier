...
<div class="step-indicator" role="navigation" aria-label="Form progress">
    <div class="step-indicator-inner">
        ...
        @endunless
        <div class="si-item {{ ($embeddedInPortal ?? false) ? 'active' : '' }}" data-step="2">
            <div class="si-num" id="si-num-2">{{ ($embeddedInPortal ?? false) ? '1' : '2' }}</div>
            <span class="si-label">Services</span>
            <span class="si-chevron">›</span>
        </div>
        <div class="si-item" data-step="3">
            <div class="si-num" id="si-num-3">{{ ($embeddedInPortal ?? false) ? '2' : '3' }}</div>
            <span class="si-label">Add-ons</span>
            <span class="si-chevron">›</span>
        </div>
        <div class="si-item" data-step="4">
            <div class="si-num" id="si-num-4">{{ ($embeddedInPortal ?? false) ? '3' : '4' }}</div>
            <span class="si-label">Brief</span>
            <span class="si-chevron">›</span>
        </div>
        <div class="si-item" data-step="5">
            <div class="si-num" id="si-num-5">{{ ($embeddedInPortal ?? false) ? '4' : '5' }}</div>
...
<div class="page-wrap">
    <div class="form-panel" id="form-panel">
        ...
        <div class="step {{ ($embeddedInPortal ?? false) ? '' : 'active' }}" id="step-1">
        ...
        <div class="step {{ ($embeddedInPortal ?? false) ? 'active' : '' }}" id="step-2">
            <div class="form-panel-header">
                <div class="fph-step">{{ ($embeddedInPortal ?? false) ? 'Step 1 of 4' : 'Step 2 of 5' }}</div>
        ...
        <div class="step" id="step-3">
            <div class="form-panel-header">
                <div class="fph-step">{{ ($embeddedInPortal ?? false) ? 'Step 2 of 4' : 'Step 3 of 5' }}</div>
        ...
        <div class="step" id="step-4">
            <div class="form-panel-header">
                <div class="fph-step">{{ ($embeddedInPortal ?? false) ? 'Step 3 of 4' : 'Step 4 of 5' }}</div>
        ...
        <div class="step" id="step-5">
            <div class="form-panel-header">
                <div class="fph-step">{{ ($embeddedInPortal ?? false) ? 'Step 4 of 4' : 'Step 5 of 5' }}</div>
        ...
        <div class="step-success" id="step-success">
            ...
            <a href="{{ $successBackUrl ?? route('site.home') }}" class="btn-new-project" onclick="return goBackToPrevious(event)">{{ $successBackLabel ?? '← Back to i2Medier' }}</a>
        </div>
    </div>
