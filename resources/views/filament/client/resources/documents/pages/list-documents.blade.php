<x-filament-panels::page>
    @php
        $stats = [
            ['label' => 'Total Documents', 'value' => '68', 'note' => 'All time', 'iconClass' => 'bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-info)]', 'icon' => 'folder'],
            ['label' => 'Uploaded Documents', 'value' => '42', 'note' => 'This year', 'iconClass' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]', 'icon' => 'upload'],
            ['label' => 'Downloaded Documents', 'value' => '26', 'note' => 'This year', 'iconClass' => 'bg-[var(--i2-color-violet-soft)] dark:bg-[rgba(124,85,255,.18)] text-[var(--i2-color-violet)]', 'icon' => 'download'],
            ['label' => 'Storage Used', 'value' => '2.45 GB', 'note' => 'of 10 GB', 'iconClass' => 'bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)]', 'icon' => 'storage'],
            ['label' => 'Folders', 'value' => '12', 'note' => 'Total folders', 'iconClass' => 'bg-[var(--i2-color-danger-soft)] dark:bg-[rgba(255,59,48,.18)] text-[var(--i2-color-danger)]', 'icon' => 'document'],
        ];

        $documents = [
            ['kind' => 'folder', 'title' => 'Project Proposals', 'subtitle' => '12 documents', 'tag' => ['label' => 'Project', 'class' => 'bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-info)]'], 'by' => 'Acme Ltd', 'date' => 'May 15, 2025', 'time' => '10:30 AM', 'size' => '--', 'favorite' => false],
            ['kind' => 'pdf', 'title' => 'Brand Guidelines.pdf', 'subtitle' => null, 'tag' => ['label' => 'Design', 'class' => 'bg-[var(--i2-color-violet-soft)] dark:bg-[rgba(124,85,255,.18)] text-[var(--i2-color-violet)]'], 'by' => 'Acme Ltd', 'date' => 'May 13, 2025', 'time' => '12:05 PM', 'size' => '3.2 MB', 'favorite' => true],
            ['kind' => 'pdf', 'title' => 'Hosting Setup Guide.pdf', 'subtitle' => null, 'tag' => ['label' => 'Hosting', 'class' => 'bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-info)]'], 'by' => 'i2Medier', 'date' => 'May 11, 2025', 'time' => '04:15 PM', 'size' => '2.1 MB', 'favorite' => false],
            ['kind' => 'xlsx', 'title' => 'Monthly Report - April 2025.xlsx', 'subtitle' => null, 'tag' => ['label' => 'Reports', 'class' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]'], 'by' => 'Acme Ltd', 'date' => 'May 8, 2025', 'time' => '01:15 PM', 'size' => '834 KB', 'favorite' => true],
            ['kind' => 'folder', 'title' => 'Logos & Brand Assets', 'subtitle' => '8 documents', 'tag' => ['label' => 'Design', 'class' => 'bg-[var(--i2-color-violet-soft)] dark:bg-[rgba(124,85,255,.18)] text-[var(--i2-color-violet)]'], 'by' => 'Acme Ltd', 'date' => 'May 5, 2025', 'time' => '10:05 AM', 'size' => '--', 'favorite' => false],
            ['kind' => 'ppt', 'title' => 'Project Presentation.pptx', 'subtitle' => null, 'tag' => ['label' => 'Presentation', 'class' => 'bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)]'], 'by' => 'Acme Ltd', 'date' => 'May 3, 2025', 'time' => '05:20 PM', 'size' => '5.4 MB', 'favorite' => false],
            ['kind' => 'pdf', 'title' => 'SSL Certificate (acme.com).pdf', 'subtitle' => null, 'tag' => ['label' => 'Certificates', 'class' => 'bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-info)]'], 'by' => 'Acme Ltd', 'date' => 'Apr 30, 2025', 'time' => '04:50 PM', 'size' => '380 KB', 'favorite' => false],
        ];
        ...
        <section class="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1.7fr)_280px]">
                ...
                <x-client.panel padding="none">
                    <div class="flex flex-col items-start justify-between gap-3 px-[18px] pb-0 pt-[14px] xl:flex-row xl:items-center">
                        <div class="flex w-full items-center gap-[34px] overflow-x-auto" aria-label="Document filters">
                            <button type="button" class="relative whitespace-nowrap px-[2px] pb-[14px] pt-2 text-[var(--i2-color-accent)] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[3px] after:rounded-full after:bg-[var(--i2-color-accent)] after:content-['']">All Documents</button>
                            <button type="button" class="whitespace-nowrap px-[2px] pb-[14px] pt-2 text-[var(--i2-color-text-soft)]">Recently Uploaded</button>
                            <button type="button" class="whitespace-nowrap px-[2px] pb-[14px] pt-2 text-[var(--i2-color-text-soft)]">Shared with Me</button>
                            <button type="button" class="whitespace-nowrap px-[2px] pb-[14px] pt-2 text-[var(--i2-color-text-soft)]">Favorites</button>
                        </div>
                    ...
                    <div class="px-[18px]">
                        <div class="hidden items-center gap-3 border-t border-[var(--i2-color-border-soft)] dark:border-white/8 py-[12px] text-[.92rem] text-[var(--i2-color-text-faint)] dark:text-white/35 xl:grid xl:grid-cols-[38px_minmax(220px,1fr)_108px_126px_132px_84px_90px]">
                        ...
                        @foreach ($documents as $document)
                            <div class="grid gap-3 border-t border-[var(--i2-color-border-soft)] dark:border-white/8 py-[10px] text-[var(--i2-color-text-soft)] dark:text-white/55 xl:grid-cols-[38px_minmax(220px,1fr)_108px_126px_132px_84px_90px] xl:items-center xl:gap-3">
                                ...
                                <div class="flex min-w-0 items-center gap-[14px]">
                                    <span class="@if($document['kind']==='folder') bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-text-soft)] @elseif($document['kind']==='pdf') bg-[var(--i2-color-danger-soft)] dark:bg-[rgba(255,59,48,.18)] text-[var(--i2-color-danger)] @elseif($document['kind']==='xlsx') bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)] @elseif($document['kind']==='ppt') bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)] @else bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-info)] @endif grid size-8 shrink-0 place-items-center rounded-[10px]">
                                    ...
                                    <div class="min-w-0">
                                        <strong class="block font-medium text-[var(--i2-color-brand-ink)] dark:text-white/90">{{ $document['title'] }}</strong>
                                        @if ($document['subtitle'])
                                            <small class="mt-1.5 block text-[var(--i2-color-text-faint)] dark:text-white/35">{{ $document['subtitle'] }}</small>
                                        @endif
                                    </div>
                                </div>
                                <span><b class="{{ $document['tag']['class'] }} inline-flex min-h-[20px] items-center justify-center rounded-[5px] px-2 text-[0.72rem] font-semibold not-italic">{{ $document['tag']['label'] }}</b></span>
                                <span>{{ $document['by'] }}</span>
                                <span>{{ $document['date'] }}<br><small class="text-[var(--i2-color-text-faint)] dark:text-white/35">{{ $document['time'] }}</small></span>
            ...
            <aside class="grid gap-4">
                <x-client.panel class="px-[16px] pb-[14px] pt-[14px]">
                    <h2 class="text-[0.88rem] font-semibold tracking-[-0.02em]">Storage Overview</h2>
                    <div class="my-[18px] grid place-items-center">
                        <div class="relative size-[148px] rounded-full bg-[conic-gradient(var(--i2-color-info)_0_24.5%,var(--i2-color-border-strong)_24.5%_100%)]">
                            ...
                            <div class="absolute inset-0 z-[1] grid place-content-center text-center">
                                ...
                                <span class="mt-1 text-[var(--i2-color-text-faint)] dark:text-white/35">Used</span>
                            </div>
                        </div>
                    </div>
                    <div class="grid gap-2.5">
                        <div class="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-[10px] text-[var(--i2-color-text-soft)] dark:text-white/55"><span class="size-[10px] rounded-full bg-[var(--i2-color-info)]"></span><span>Documents</span><strong>2.45 GB</strong></div>
                        <div class="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-[10px] text-[var(--i2-color-text-soft)] dark:text-white/55"><span class="size-[10px] rounded-full bg-[var(--i2-color-border-strong)]"></span><span>Available</span><strong>7.55 GB</strong></div>
                        <div class="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-[10px] text-[var(--i2-color-text-soft)] dark:text-white/55"><span>Total</span><strong>10 GB</strong></div>
                    </div>
                </x-client.panel>

                <x-client.panel class="px-[16px] pb-[14px] pt-[14px]">
                    <h2 class="text-[0.88rem] font-semibold tracking-[-0.02em]">Quick Actions</h2>
                    <div class="mt-3 grid gap-2.5">
                        <button type="button" class="flex items-center gap-2.5 text-left text-[var(--i2-color-brand-ink)] dark:text-white/90">
                            <span class="text-[var(--i2-color-text-faint)] dark:text-white/35"><svg viewBox="0 0 24 24" class="size-[18px] fill-none stroke-current [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:1.8]" aria-hidden="true"><path d="M12 16V7"></path><path d="m8.5 10.5 3.5-3.5 3.5 3.5"></path><path d="M7 18.5h10a3.5 3.5 0 0 0 .3-7A5.5 5.5 0 0 0 7 11.8 3.3 3.3 0 0 0 7 18.5Z"></path></svg></span>
                            <span>Upload Document</span>
                        </button>
                        <button type="button" class="flex items-center gap-2.5 text-left text-[var(--i2-color-brand-ink)] dark:text-white/90">
                        ...
                        <button type="button" class="flex items-center gap-2.5 text-left text-[var(--i2-color-brand-ink)] dark:text-white/90">
                            <span class="text-[var(--i2-color-text-faint)] dark:text-white/35"><svg viewBox="0 0 24 24" class="size-[18px] fill-none stroke-current [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:1.8]" aria-hidden="true"><path d="M12 7v9"></path><path d="m8.5 12.5 3.5 3.5 3.5-3.5"></path><path d="M5 19h14"></path></svg></span>
                ...
                <x-client.panel class="px-[16px] pb-[14px] pt-[14px]">
                    <h2 class="text-[0.88rem] font-semibold tracking-[-0.02em]">File Types</h2>
                    <div class="mt-4 grid gap-2">
                        @foreach ($fileTypes as $fileType)
                            <div class="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 text-[var(--i2-color-text-soft)]">
                                <div class="flex items-center gap-2">
                                    <span class="@if($fileType['kind']==='pdf') bg-[var(--i2-color-danger-soft)] dark:bg-[rgba(255,59,48,.18)] text-[var(--i2-color-danger)] @elseif($fileType['kind']==='docx') bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-info)] @elseif($fileType['kind']==='xlsx') bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)] @elseif($fileType['kind']==='zip') bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)] @else bg-[var(--i2-color-info-soft)] dark:bg-[rgba(60,124,255,.18)] text-[var(--i2-color-text-soft)] @endif grid size-[14px] place-items-center rounded-[6px]">
