<x-filament-panels::page>
    @php
        $stats = [
            ['label' => 'Total Domains', 'value' => '8', 'note' => 'All domains', 'iconClass' => 'bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)]', 'icon' => 'globe'],
            ['label' => 'Active', 'value' => '6', 'note' => '75% of total', 'iconClass' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]', 'icon' => 'active'],
            ['label' => 'Expiring Soon', 'value' => '2', 'note' => '25% of total', 'iconClass' => 'bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)]', 'icon' => 'expiring'],
            ['label' => 'Expired', 'value' => '0', 'note' => '0% of total', 'iconClass' => 'bg-[var(--i2-color-danger-soft)] dark:bg-[rgba(255,59,48,.18)] text-[var(--i2-color-danger)]', 'icon' => 'expired'],
        ];

        $domains = [
            ['name' => 'acme.com', 'registered' => 'Registered on May 15, 2024', 'status' => ['label' => 'Active', 'class' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]'], 'renewal' => 'May 15, 2025', 'renewalNote' => '23 days left', 'renewalClass' => 'text-[var(--i2-color-warning)]', 'autoRenew' => true, 'protected' => true],
            ['name' => 'acme.net', 'registered' => 'Registered on May 20, 2024', 'status' => ['label' => 'Active', 'class' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]'], 'renewal' => 'May 20, 2025', 'renewalNote' => '28 days left', 'renewalClass' => 'text-[var(--i2-color-warning)]', 'autoRenew' => true, 'protected' => true],
            ['name' => 'acme.org', 'registered' => 'Registered on Jun 10, 2024', 'status' => ['label' => 'Active', 'class' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]'], 'renewal' => 'Jun 10, 2025', 'renewalNote' => '49 days left', 'renewalClass' => 'text-[var(--i2-color-warning)]', 'autoRenew' => true, 'protected' => true],
            ['name' => 'acme.io', 'registered' => 'Registered on May 25, 2024', 'status' => ['label' => 'Active', 'class' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]'], 'renewal' => 'May 25, 2025', 'renewalNote' => '33 days left', 'renewalClass' => 'text-[var(--i2-color-warning)]', 'autoRenew' => false, 'protected' => true],
            ['name' => 'acme.dev', 'registered' => 'Registered on May 20, 2024', 'status' => ['label' => 'Expiring Soon', 'class' => 'bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)]'], 'renewal' => 'May 20, 2025', 'renewalNote' => '28 days left', 'renewalClass' => 'text-[var(--i2-color-warning)]', 'autoRenew' => true, 'protected' => false],
            ['name' => 'acme.co', 'registered' => 'Registered on Jun 12, 2024', 'status' => ['label' => 'Expiring Soon', 'class' => 'bg-[var(--i2-color-warning-soft)] dark:bg-[rgba(218,132,0,.22)] text-[var(--i2-color-warning)]'], 'renewal' => 'Jun 12, 2025', 'renewalNote' => '51 days left', 'renewalClass' => 'text-[var(--i2-color-warning)]', 'autoRenew' => false, 'protected' => true],
            ['name' => 'acmeapp.com', 'registered' => 'Registered on Jun 05, 2023', 'status' => ['label' => 'Expired', 'class' => 'bg-[var(--i2-color-danger-soft)] dark:bg-[rgba(255,59,48,.18)] text-[var(--i2-color-danger)]'], 'renewal' => '-', 'renewalNote' => 'Expired on Jun 05, 2024', 'renewalClass' => 'text-[var(--i2-color-danger)]', 'autoRenew' => false, 'protected' => false],
            ['name' => 'oldproject.net', 'registered' => 'Registered on Apr 10, 2023', 'status' => ['label' => 'Active', 'class' => 'bg-[var(--i2-color-success-soft)] dark:bg-[rgba(26,107,58,.28)] text-[var(--i2-color-success)]'], 'renewal' => 'Apr 10, 2025', 'renewalNote' => '-5 days left', 'renewalClass' => 'text-[var(--i2-color-danger)]', 'autoRenew' => false, 'protected' => false],
        ];
    @endphp
        ...
        <x-client.panel padding="none">
            <div class="flex flex-col items-start justify-between gap-3 px-[18px] pb-0 pt-[14px] xl:flex-row xl:items-center">
                <div class="flex w-full items-center gap-7 overflow-x-auto pb-1" aria-label="Domain filters">
                    <button type="button" class="relative whitespace-nowrap pb-[14px] pt-2 text-[var(--i2-color-accent)] after:absolute after:bottom-0 after:left-[-6px] after:right-[-6px] after:h-[3px] after:rounded-full after:bg-[var(--i2-color-accent)] after:content-['']">All Domains</button>
                    ...
                    <button type="button" class="whitespace-nowrap pb-[14px] pt-2 text-[var(--i2-color-text-soft)]">Expired</button>
                </div>
            ...
            <div class="px-[18px] pb-0 pt-2">
                <div class="hidden items-center gap-[18px] border-t border-[var(--i2-color-border-soft)] dark:border-white/8 px-[2px] py-3 text-[.94rem] text-[var(--i2-color-text-soft)] xl:grid xl:grid-cols-[minmax(280px,2.1fr)_150px_180px_130px_180px_128px]">
                ...
                @foreach ($domains as $domain)
                    <article class="grid gap-3 border-t border-[var(--i2-color-border-soft)] dark:border-white/8 px-[2px] py-3 xl:grid-cols-[minmax(280px,2.1fr)_150px_180px_130px_180px_128px] xl:items-center xl:gap-[18px]">
                        <div class="flex min-w-0 items-center gap-4">
                            <div class="grid size-8 shrink-0 place-items-center rounded-[10px] bg-[var(--i2-color-violet-soft)] text-[var(--i2-color-text-soft)]">
                                <svg viewBox="0 0 24 24" class="size-[18px] fill-none stroke-current [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:1.8]" aria-hidden="true"><circle cx="12" cy="12" r="7"></circle><path d="M5 12h14"></path><path d="M12 5a10.7 10.7 0 0 1 3 7 10.7 10.7 0 0 1-3 7 10.7 10.7 0 0 1-3-7 10.7 10.7 0 0 1 3-7Z"></path></svg>
                            </div>
                            <div class="min-w-0">
                                <h2 class="mb-1.5 text-[0.88rem] font-semibold tracking-[-0.02em]">{{ $domain['name'] }}</h2>
                                <p class="text-[0.78rem] text-[var(--i2-color-text-faint)]">{{ $domain['registered'] }}</p>
                            </div>
                        </div>

                        <div>
                            <span class="{{ $domain['status']['class'] }} inline-flex min-h-[20px] items-center justify-center rounded-[6px] px-[10px] text-[0.78rem] font-semibold">{{ $domain['status']['label'] }}</span>
                        </div>

                        <div>
                            <strong class="block text-[0.82rem] font-medium text-[var(--i2-color-text-soft)]">{{ $domain['renewal'] }}</strong>
            ...
            <div class="flex flex-col items-start justify-between gap-3 px-[18px] pb-[12px] pt-[14px] xl:flex-row xl:items-center">
                <p class="text-[0.8rem] text-[var(--i2-color-text-faint)]">Showing 1 to 8 of 8 domains</p>
                <div class="flex items-center gap-[10px]">
