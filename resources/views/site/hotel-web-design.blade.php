...
@push('meta')
<meta name="description" content="Booking-focused web design for hotels, resorts, boutique stays and serviced apartments in Nigeria. i2Medier builds stunning hotel websites that drive direct bookings and cut OTA commissions. Lagos, Abuja & UK specialists."/>
<meta name="keywords" content="web design for hotels Nigeria, hotel website design, hotel booking website Nigeria, resort website design Lagos, boutique hotel website Nigeria, hospitality website design, hotel direct booking website, serviced apartment website Nigeria, hotel website Lagos, bed and breakfast website Nigeria"/>
<meta name="robots" content="index, follow"/>
<meta name="author" content="i2Medier Konceptz"/>
<link rel="canonical" href="{{ url('/services/web-design/hotel-website-design') }}"/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="{{ url('/services/web-design/hotel-website-design') }}"/>
<meta property="og:title" content="Web Design for Hotels | Hotel Booking Website Design Nigeria | i2Medier"/>
<meta property="og:description" content="We build hotel websites that win direct bookings away from Booking.com and Expedia — cutting OTA commissions and putting revenue back in your pocket. Nigeria & UK specialists."/>
<meta property="og:image" content="{{ url('/og-hotel-web-design.jpg') }}"/>
<meta property="og:site_name" content="i2Medier"/>
<meta name="twitter:card" content="summary_large_image"/>
<meta name="twitter:title" content="Web Design for Hotels | Hotel Booking Website Design Nigeria | i2Medier"/>
<meta name="twitter:description" content="Hotel websites that drive direct bookings and slash OTA commissions. Nigeria & UK specialists."/>
<script type="application/ld+json">{!! json_encode([
  '@context' => 'https://schema.org',
  '@type' => 'Service',
  'name' => 'Web Design for Hotels & Hospitality',
  'serviceType' => 'Web Design & Development',
  'description' => 'Booking-focused web design and development services for hotels, resorts, boutique stays, serviced apartments, bed and breakfasts, and hospitality brands. We build fast, SEO-optimised hotel websites that drive direct bookings, reduce OTA dependency, and showcase rooms beautifully.',
  'provider' => [
    '@type' => 'Organization',
    'name' => 'i2Medier',
    'url' => url('/'),
  ...
  'audience' => [
    '@type' => 'Audience',
    'audienceType' => 'Hotels, Resorts, Boutique Hotels, Serviced Apartments, Bed and Breakfasts, Guest Houses, Airport Hotels',
  ],
  'offers' => [
    '@type' => 'Offer',
    'priceCurrency' => 'NGN',
    'price' => '500000',
    'description' => 'Hotel website starting from ₦500,000',
  ],
...
<script type="application/ld+json">{!! json_encode([
  ...
  'itemListElement' => [
    ...
    ['@type' => 'ListItem', 'position' => 4, 'name' => 'Web Design for Hotels', 'item' => url('/services/web-design/hotel-website-design')],
  ],
], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}</script>
@endpush
