...
<section class="results-section" aria-labelledby="results-heading">
  ...
  <div class="results-grid">
    <div class="result-card reveal"><div class="result-num"><span class="counter" data-target="340">0</span><span>%</span></div><div class="result-label">Increase in organic search visibility within 90 days of campaign launch</div><p class="result-project">Meto7 Chauffeur Services moved from zero page-one rankings to position #1 for "chauffeur service London" and 6 additional target keywords within 3 months.</p><a href="{{ route('portfolio.case-study.meto7') }}" class="result-link">Read Case Study →</a></div>
