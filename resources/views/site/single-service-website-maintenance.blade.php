...
@push('scripts')
    @vite('resources/js/public/pages/service-website-maintenance.js')
@endpush
  ...
  <section class="packages-section" aria-labelledby="packages-heading" id="packages">
    ...
    <div class="pkg-grid">
      <div class="pkg-card reveal">
        ...
        <div class="pkg-foot"><a href="{{ route('site.start', ['services' => 'webmaintenance', 'source_page' => 'service-website-maintenance', 'source_label' => 'Website Maintenance Service Page']) }}" class="pkg-btn outline">Get Started</a></div>
      </div>
