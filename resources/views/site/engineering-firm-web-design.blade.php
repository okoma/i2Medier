...
@push('meta')
<meta name="description" content="Professional web design for engineering firms, civil engineers, mechanical engineers, and structural engineering consultancies. i2Medier builds fast, SEO-optimised engineering company websites that win project enquiries and establish technical authority in Nigeria and the UK."/>
<meta name="keywords" content="web design for engineering firms, engineering company website Nigeria, civil engineering website design, mechanical engineering firm website, structural engineer website Nigeria, engineering consultancy website Lagos, COREN registered engineer website, engineering firm web design, engineer website design Abuja, engineering company website development"/>
<meta name="robots" content="index, follow"/>
<meta name="author" content="i2Medier Konceptz"/>
<link rel="canonical" href="{{ url('/services/web-design/engineering-firm-website-design') }}"/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="{{ url('/services/web-design/engineering-firm-website-design') }}"/>
<meta property="og:title" content="Web Design for Engineering Firms | i2Medier"/>
<meta property="og:description" content="We build professional websites for engineering firms that turn web visitors into project enquiries. Fast, technically credible, and optimised for Google from day one."/>
<meta property="og:image" content="{{ url('/og-engineering-web-design.jpg') }}"/>
<meta property="og:site_name" content="i2Medier"/>
<meta name="twitter:card" content="summary_large_image"/>
<meta name="twitter:title" content="Web Design for Engineering Firms | i2Medier"/>
<meta name="twitter:description" content="Professional engineering firm websites that rank on Google and win project enquiries. Nigeria & UK specialists."/>
<script type="application/ld+json">{!! json_encode([
  '@context' => 'https://schema.org',
  '@type' => 'Service',
  'name' => 'Engineering Firm Website Design',
  'serviceType' => 'Engineering Firm Website Design',
  'description' => 'Professional web design and development services for engineering firms, civil engineering consultancies, mechanical engineering companies, structural engineering firms, and electrical engineering practices. We build fast, SEO-optimised websites that showcase technical authority, display COREN and NSE credentials, and convert site visitors into project enquiries.',
  'provider' => [
    '@type' => 'Organization',
    'name' => 'i2Medier',
    'url' => url('/'),
  ...
  'audience' => [
    '@type' => 'Audience',
    'audienceType' => 'Civil engineering firms, Structural engineering consultancies, Mechanical engineering companies, Electrical engineering firms, COREN registered engineers, NSE members, Environmental engineering consultancies',
  ],
  'offers' => [
    '@type' => 'Offer',
    'priceCurrency' => 'NGN',
    'price' => '350000',
    'description' => 'Engineering firm website starting from ₦350,000',
  ],
...
<script type="application/ld+json">{!! json_encode([
  ...
  'itemListElement' => [
    ...
    ['@type' => 'ListItem', 'position' => 4, 'name' => 'Web Design for Engineering Firms', 'item' => url('/services/web-design/engineering-firm-website-design')],
  ],
], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}</script>
@endpush
