...
{!! json_encode([
    ...
    'itemListElement' => [
        ...
        [
            ...
            'item' => route('tools.business-name-generator'),
        ],
    ],
...
{!! json_encode([
    ...
    'name' => 'AI Business Name Generator',
    'url' => route('tools.business-name-generator'),
    'applicationCategory' => 'WebApplication',
    'operatingSystem' => 'Any',
    'offers' => ['@type' => 'Offer', 'price' => '0', 'priceCurrency' => 'NGN'],
    'description' => 'Free AI-powered business name generator. Get instant, creative name ideas for your Nigerian business in seconds — no signup required.',
